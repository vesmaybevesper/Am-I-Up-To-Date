...
public class FastJsonConfigSerializer<T> extends ConfigSerializer<T> {
	...
	public static class StyleWriter implements ObjectWriter<Style> {
		public static final FastJsonConfigSerializer.StyleWriter INSTANCE = new FastJsonConfigSerializer.StyleWriter();
	...
	public static class StyleReader implements ObjectReader<Style> {
		public static final FastJsonConfigSerializer.StyleReader INSTANCE = new FastJsonConfigSerializer.StyleReader();
...
//?}
	...
	public static class ColorWriter implements ObjectWriter<Color> {
		public static final FastJsonConfigSerializer.ColorWriter INSTANCE = new FastJsonConfigSerializer.ColorWriter();
	...
	public static class ColorReader implements ObjectReader<Color> {
		public static final FastJsonConfigSerializer.ColorReader INSTANCE = new FastJsonConfigSerializer.ColorReader();
	...
	public static class ItemWriter implements ObjectWriter<Item> {
		public static final FastJsonConfigSerializer.ItemWriter INSTANCE = new FastJsonConfigSerializer.ItemWriter();
	...
	public static class ItemReader implements ObjectReader<Item> {
		public static final FastJsonConfigSerializer.ItemReader INSTANCE = new FastJsonConfigSerializer.ItemReader();
